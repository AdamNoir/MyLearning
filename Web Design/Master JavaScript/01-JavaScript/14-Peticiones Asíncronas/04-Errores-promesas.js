...
getUsuarios()
    ...
    // Mostrar data de la primesa creada
    .then(data => {
...
function getUsuarios(){
    return fetch("https://reqres.in3123/api/users");
}
...
function getInfo(){
    ...
    return new Promise((resolve, reject) => {
        var profesor_string = "";
        setTimeout(function(){
            // al pasar los 3 segundos se convertira en un json string
            profesor_string = JSON.stringify(profesor);
            // si es string lo pasa, sino lanza un error
